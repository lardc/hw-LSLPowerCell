...
const TableItemConstraint NVConstraint[DATA_TABLE_NV_SIZE] = {
		...
		{0, INT16U_MAX, REG_REGULATOR_QI_DEF},										// 7
		{NO, YES, YES},																// 8
		...
		{I_RANGE0_THRESHOLD_MIN, I_RANGE0_THRESHOLD_MAX, I2DAC_CUST_RANGE0_DEF},	// 17
		{I_RANGE1_THRESHOLD_MIN, I_RANGE1_THRESHOLD_MAX, I2DAC_CUST_RANGE1_DEF},	// 18
		{0, 0, 0},																	// 19
		{COEF_K_MIN, COEF_K_MAX, I_TO_DAC_RANGE0_K_DEF},							// 20
		{OFFSET_MIN, OFFSET_MAX, I_TO_DAC_RANGE0_B_DEF},							// 21
		{COEF_K_MIN, COEF_K_MAX, I_TO_DAC_RANGE1_K_DEF},							// 22
		{OFFSET_MIN, OFFSET_MAX, I_TO_DAC_RANGE1_B_DEF},							// 23
		{COEF_K_MIN, COEF_K_MAX, I_TO_DAC_RANGE2_K_DEF},							// 24
		{OFFSET_MIN, OFFSET_MAX, I_TO_DAC_RANGE2_B_DEF},							// 25
		{V_BAT_K_MIN, V_BAT_K_MAX, V_BAT_K_DEF},									// 26
		{OFFSET_MIN, OFFSET_MAX, OFFSET_DEF},										// 27
		{COEF_K_MIN, COEF_K_MAX, K_AMP_RANGE0_DEF},									// 28
		{COEF_K_MIN, COEF_K_MAX, K_AMP_RANGE1_DEF},									// 29
		...
		{0, 0, 0},																	// 58
		{0, 0, 0},																	// 59
		{0, INT16U_MAX, CAN_SLAVE_NID_DEF},											// 60
		{0, INT16U_MAX, CURRENT_SETPOINT_MIN},										// 61
		{0, INT16U_MAX, CURRENT_SETPOINT_MAX},										// 62
		{NO, YES, NO},																// 63
		{NO, YES, NO},																// 64
		{0, 0, 0},																	// 65
		{0, 0, 0},																	// 66
		...
		{0, 0, 0},																	// 69
		{0, 0, 0},																	// 70
		{ALLOWED_ERR_MIN, ALLOWED_ERR_MAX, ALLOWED_ERR_DEF},						// 71
		{FOLLOWING_ERR_CNT_MIN,FOLLOWING_ERR_CNT_MAX,FOLLOWING_ERR_CNT_DEF},		// 72
		{NO, YES, NO},																// 73
		{0, 0, 0},																	// 74
		{0, 0, 0},																	// 75
		{0, 0, 0},																	// 76
