...
#define REG_I2DAC_CUST_RANGE0			17	// Граница кастомного диапазона 0 для пересчёта тока в ЦАП (А * 10) (рекомендуется 350А)
#define REG_I2DAC_CUST_RANGE1			18	// Граница кастомного диапазона 1 для пересчёта тока в ЦАП (А * 10) (рекомендуется 1100А)

#define REG_I_TO_DAC_RANGE0_K			20	// Диапазон 0 - Коэффициент пересчета в значение ЦАП (*1000)
#define REG_I_TO_DAC_RANGE0_B			21	// Диапазон 0 - Смещение пересчета в значение ЦАП
#define REG_I_TO_DAC_RANGE1_K			22	// Диапазон 1 - Коэффициент пересчета в значение ЦАП (*1000)
#define REG_I_TO_DAC_RANGE1_B			23	// Диапазон 1 - Смещение пересчета в значение ЦАП
#define REG_I_TO_DAC_RANGE2_K			24	// Диапазон 2 - Коэффициент пересчета в значение ЦАП (*1000)
...
//
#define REG_REGULATOR_ALLOWED_ERR		71	// Максимально допустимая ошибка регулятора
#define REG_FOLLOWING_ERR_CNT			72	// Максимальное значение счетчика FollowingError
#define REG_FOLLOWING_ERR_MUTE			73	// Выключение слежения за FollowingError
...
#define REG_RESULT_CURRENT2				203	// Достигнутое значение импульса тока (А)
#define REG_RESULT_CURRENT2_FRAC		204	// Достигнутое значение импульса тока, дробная часть (в мА)
// -----------------------------
